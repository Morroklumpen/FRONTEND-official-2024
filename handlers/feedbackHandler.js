...
function notAuthorized() {
  return createFeedback(
    UNAUTHORIZED,
    "Your authorization level does not allow you to access this feature!"
  );
}
...
function internalServerError() {
  return createFeedback(
    INTERNALSERVERERROR,
    "The server encountered an unexpected condition and could not fulfull your request. If this problem persist, please contact the server administrator with a description of your problem."
  );
}
...
function resourceNotFound() {
  return createFeedback(
    RESOURCENOTFOUND,
    "The target of this operation was not found!"
  );
}
 ...
 */
function createFeedback(statuscode, feedback, isSuccess = false, payload = {}) {
  return {
    statuscode,
    feedback,
    isSuccess,
